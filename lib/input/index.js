...
var Input = function (_Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.getInput = function () {
      return _this.input;
  ...
  _createClass(Input, [{
    ...
    value: function getClassName() {
      ...
      var className = required || disabled || readOnly ? 'cog ' + (0, _classnames2.default)({ required: required, disabled: disabled, readOnly: readOnly }) : 'cog';

      return this.hasError() ? className + ' error' : className;
    }
  }, {
    key: 'getId',
    ...
    key: 'renderIsRequired',
    value: function renderIsRequired() {
    ...
    key: 'renderIsDisabled',
    value: function renderIsDisabled() {
    ...
    key: 'renderIsReadOnly',
    value: function renderIsReadOnly() {
